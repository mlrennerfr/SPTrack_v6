...
%   $Revision: 5.27 $  $Date: 2002/03/15 15:29:11 $
...
roix = axes2pixold(num_cols, xdata, xi);
roiy = axes2pixold(num_rows, ydata, yi);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function pixelx = axes2pixold(dim, x, axesx)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [x,y] = intlineold(x1, x2, y1, y2)
